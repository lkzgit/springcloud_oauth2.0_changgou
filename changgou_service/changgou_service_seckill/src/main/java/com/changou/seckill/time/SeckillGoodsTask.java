package com.changou.seckill.time;

import com.changou.seckill.dao.SeckillGoodsMapper;
...
public class SeckillGoodsTask {
    ...
    public void pushGoodsToRedis(){
        // 获取对应时间段数据
        List<Date> dateMenus = entity.DateUtil.getDateMenus();
        for (Date dateMenu : dateMenus) {
            // redis 的key构建
            String extName = entity.DateUtil.data2str(dateMenu, entity.DateUtil.PATTERN_YYYYMMDDHH);
